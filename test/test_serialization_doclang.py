...
def test_kv():
    ...
    doc.add_text(label=DocItemLabel.FIELD_HINT, text="Select this if you are a Superman fan", parent=opt_vis)
...
def test_kv_nested():
    ...
    doc.add_text(label=DocItemLabel.MARKER, text="1.", parent=kve_inner)
    ...
    kve_inner = doc.add_field_item(parent=kvm_inner)
    doc.add_text(label=DocItemLabel.MARKER, text="2.", parent=kve_inner)
