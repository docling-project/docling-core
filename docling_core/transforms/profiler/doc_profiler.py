...
class CollectionStats(BaseModel):
    ...
    median_pages: Annotated[float, Field(description="Median number of pages per document")] = 0.0
    ...
    median_tables: Annotated[float, Field(description="Median number of tables per document")] = 0.0
    ...
    median_pictures: Annotated[float, Field(description="Median number of pictures per document")] = 0.0
    ...
    median_texts: Annotated[float, Field(description="Median number of text items per document")] = 0.0
    ...
    median_pictures_for_ocr: Annotated[
        float, Field(description="Median number of pictures requiring OCR per document")
    ] = 0.0
...
class DocumentProfiler:
    ...
    def profile_collection(
        ...
        return CollectionStats(
            ...
            median_tables=statistics.median(tables_list),
            ...
            median_pictures=statistics.median(pictures_list),
            ...
            median_texts=statistics.median(texts_list),
            ...
            median_pictures_for_ocr=statistics.median(pictures_for_ocr_list),
